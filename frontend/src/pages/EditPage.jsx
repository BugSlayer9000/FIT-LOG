...
const EditPage = () => {
  ...
  return (
    <div className="border min-h-screen bg-base-200">
      <div className="border container mx-auto px-4 py-8">
        <div className="border max-w-xl mx-auto">
          <div className="border flex items-center justify-between mb-6">
